...
public class PuiUserModelConfigPk extends AbstractTableDto implements IPuiUserModelConfigPk {
	...
	@PuiGenerated
	@PuiField(columnname = IPuiUserModelConfigPk.ID_COLUMN, ispk = true, nullable = false, type = ColumnType.numeric, autoincrementable = false, maxlength = -1, islang = false, isgeometry = false, issequence = true)
	private Integer id;
