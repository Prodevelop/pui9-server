...
public class PuiModelFilterPk extends AbstractTableDto implements IPuiModelFilterPk {
	...
	@PuiGenerated
	@PuiField(columnname = IPuiModelFilterPk.ID_COLUMN, ispk = true, nullable = false, type = ColumnType.numeric, autoincrementable = false, maxlength = -1, islang = false, isgeometry = false, issequence = true)
	private Integer id;
